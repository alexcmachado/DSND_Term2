...
def return_figures():
    ...
    for country in countrylist:
        ...
        graph_one.append(go.Scatter(x=x_val, y=y_val, mode="lines", name=country))
    ...
    for country in countrylist:
        ...
        graph_three.append(go.Scatter(x=x_val, y=y_val, mode="lines", name=country))
    ...
    graph_five = []
    graph_five.append(go.Bar(x=df.country.tolist(), y=df.variable.tolist()))
